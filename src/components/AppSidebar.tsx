...
const menuItems: SidebarItem[] = [
  ...
  { id: "percentage", title: "Procente", icon: Percent },
  { id: "date", title: "Calculator Dată", icon: Calendar },
  { id: "bmi", title: "Calculator IMC", icon: Scale },
  { id: "unit", title: "Convertor Unități", icon: Ruler },
  { id: "fuel", title: "Consum Combustibil", icon: Fuel },
  { id: "time", title: "Convertor Timp", icon: Clock },
];
          ...
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div>
                ...
                <p className="text-xs text-muted-foreground">Instrumente Online</p>
              </div>
            )}
          </div>
        </div>
